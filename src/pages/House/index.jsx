...
const House = () => {
  ...
  const [importHouseBounds, setImportHouseBounds] = useState({
    left: 0,
    top: 0,
    bottom: 0,
    right: 0,
      ...
      render: (record) => {
        return (
          <>
            ...
            <Popconfirm title="删除?" onConfirm={() => onDelete(record.id)}>
              <Button style={{ marginLeft: '10px' }}>详情</Button>
            </Popconfirm>
          </>
        );
      },
    ...
    <PageContainer>
      ...
      >
        ...
        >
          ...
          <p className="ant-upload-hint">支持单文件上传，格式为excel</p>
        </Dragger>
      </Modal>
    </PageContainer>
  );
